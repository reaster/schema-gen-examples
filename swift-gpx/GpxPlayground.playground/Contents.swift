...
//[
//    {
//        "email": [{ "text": "greatspa@napanet.net" }],
//        "phone": [{ "text": "707-942-0991" }],
//        "address":[
//            {
//                "orgunit": "USFS - Mono Basin Scenic Area",
//                "street1": "US-395",
//                "street2": "(just north of Lee Vining)",
//                "boxnumber": "P.O. Box 429",
//                "city": "Lee Vining",
//                "state": "CA",
//                "zip": "93541"
//            }
...
//    country: nil
//)
//let email = Email(text: "big@cat.com", type: Email.TypeEnum.work, note: "big never replies")
//let link = Link(text: "charters", key: nil, type: LinkEnum.article, title: "Big Cat Airport", href: URL(string: "http://airport.cat.com")!)
//let item = Contact(
//    name: "Big Cat Hotel",
//    email:  [email],
//    link: [link],
...
//
//
//print("The result of encoding a \(type(of:item))")
//let encodedItem = try encoder.encode(item)
//print(String(data: encodedItem, encoding: .utf8)!)
//print()
//
//let item_out = try decoder.decode(Contact.self, from: encodedItem)
//print("\t\(item_out)")
